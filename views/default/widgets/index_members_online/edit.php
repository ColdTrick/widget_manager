...
$content = elgg_echo('widget_manager:widgets:index_members_online:member_count') . '<br />';
...
$content = elgg_echo('widget_manager:widgets:index_members_online:user_icon') . '<br />';
