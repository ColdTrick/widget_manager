<?php 
	...
	if($users = elgg_get_entities_from_relationship($options)){
		echo "<div class='contentWrapper widget_manager_widget_index_members'>";
		...
		echo elgg_view("page_elements/contentwrapper", array("body" => elgg_echo("widget_manager:widgets:index_members_online:no_result")));
	}
